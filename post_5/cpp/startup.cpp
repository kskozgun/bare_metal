...
extern "C" {
// Provide dummy exception index table
__attribute__((weak)) void* __exidx_start = nullptr;
__attribute__((weak)) void* __exidx_end = nullptr;
}
...
{
    uint32_t size = &_edata - &_sdata; // Size in uint32_t words
    ...
    size = &_ebss - &_sbss; // Size in uint32_t words
